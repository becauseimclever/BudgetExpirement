...
namespace BudgetExperiment.Infrastructure.Migrations
{
    ...
    [Migration("20250915033256_ReplaceOldSchedulesWithUnifiedRecurringSchedule")]
    partial class ReplaceOldSchedulesWithUnifiedRecurringSchedule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BudgetExperiment.Domain.AdhocPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BudgetExperiment.Domain.AdhocPayment", b =>
                {
                    b.OwnsOne("BudgetExperiment.Domain.MoneyValue", "Money", b1 =>
                        {
                            b1.Property<Guid>("AdhocPaymentId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("AdhocPaymentId");

                            b1.ToTable("AdhocPayments");

                            b1.WithOwner()
                                .HasForeignKey("AdhocPaymentId");
                        });
