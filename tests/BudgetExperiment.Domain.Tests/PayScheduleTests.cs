...
public class PayScheduleTests
{
    ...
    {
        var schedule = PaySchedule.CreateWeekly(new DateOnly(2025, 1, 3)); // anchor Friday
    ...
    {
        var schedule = PaySchedule.CreateMonthly(new DateOnly(2025, 1, 31)); // anchor end-of-month style
        var rangeStart = new DateOnly(2025, 1, 1);
    ...
    {
        var schedule = PaySchedule.CreateWeekly(new DateOnly(2025, 6, 6));
