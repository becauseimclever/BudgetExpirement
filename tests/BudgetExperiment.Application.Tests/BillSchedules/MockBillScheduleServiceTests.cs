...
public sealed class MockBillScheduleServiceTests
{
    [Fact]
    ...
    private sealed class Harness
    {
        ...
        public MockRepository Write { get; }

        public MockRepository Read { get; }

        public MockUnitOfWork Uow { get; }
    }

    private sealed class MockRepository : IWriteRepository<BillSchedule>, IReadRepository<BillSchedule>
    {
